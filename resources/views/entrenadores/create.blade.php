...
<div class="container">
    ...
    <form action="{{ route('entrenadores.store') }}" method="POST">
        ...
        <input type="text" name="especialidad" placeholder="Especialidad" value="{{ old('especialidad') }}" class="form-control mb-2">
        <input type="text" name="experiencia" placeholder="Experiencia" value="{{ old('experiencia') }}" class="form-control mb-2">
        <input type="text" name="disponibilidad" placeholder="Disponibilidad" value="{{ old('disponibilidad') }}" class="form-control mb-2">
