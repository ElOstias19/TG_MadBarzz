                        ...
                        <div class="testimonial-one owl-carousel">
                            <div class="items">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <img src="{{ asset('assets_private/images/testimonial/1.jpg') }}" alt="">
                            ...
                            <div class="items">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <img src="{{ asset('assets_private/images/testimonial/2.jpg') }}" alt="">
                                        <h5 class="fs-16 font-w500 mb-1"><a href="app-profile.html" class="text-black">Cindy
                                                Moss</a></h5>
                            ...
                            <div class="items">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <img src="{{ asset('assets_private/images/testimonial/3.jpg') }}" alt="">
                                        <h5 class="fs-16 font-w500 mb-1"><a href="app-profile.html"
                            ...
                            <div class="items">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <img src="{{ asset('assets_private/images/testimonial/4.jpg') }}" alt="">
                                        <h5 class="fs-16 font-w500 mb-1"><a href="app-profile.html" class="text-black">Louis
                                                Simatupang</a></h5>
                                        <p class="fs-14">Body Building Trainer</p>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                ...
                <div class="card featuredMenu">
                    ...
                    <div class="card-body loadmore-content height700 dz-scroll pt-0" id="FeaturedMenusContent">
                        <div class="media mb-4">
                            <img src="{{ asset('assets_private/images/menus/1.png') }}" width="85" alt=""
                                class="rounded me-3">
                            <div class="media-body">
                                <h5><a href="food-menu.html" class="text-black fs-16">Chinese Orange Fruit With Avocado
                                        Salad</a></h5>
                        ...
                        <ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                            <li class="me-3 mb-2"><i class="las la-clock scale5 me-2"></i><span class="fs-14 text-black">4-6
                                    mins </span></li>
                            <li class="mb-2"><i class="fa-regular fa-star me-2 scale1 text-warning"
                                    aria-hidden="true"></i><span class="fs-14 text-black font-w500">176 Reviews</span></li>
                        </ul>
                        <div class="media mb-4">
                            <img src="{{ asset('assets_private/images/menus/2.png') }}" width="85" alt=""
                                class="rounded me-3">
                            <div class="media-body">
                                <h5><a href="food-menu.html" class="text-black fs-16">Fresh or Frozen (No Sugar Added)
                                        Fruits</a></h5>
                        ...
                        <div class="media mb-4">
                            <img src="{{ asset('assets_private/images/menus/3.png') }}" width="85" alt=""
                                class="rounded me-3">
                            <div class="media-body">
                                <h5><a href="food-menu.html" class="text-black fs-16">Fresh or Frozen (No Sugar Added)
                                        Fruits</a></h5>
                        ...
                        <div class="media mb-4">
                            <img src="{{ asset('assets_private/images/menus/4.png') }}" width="85" alt=""
                                class="rounded me-3">
                            <div class="media-body">
                                <h5><a href="food-menu.html" class="text-black fs-16">Original Boiled Egg with Himalaya
                                        Salt</a></h5>
