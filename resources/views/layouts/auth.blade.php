    ...
    <div class="container">
      <div class="row">
        ...
        <div class="mobile-nav" id="mobile-nav">
          <div class="res-log">
            <a href="index.html">
              <img src="{{ asset('assets/images/log_text_mad.png') }}" alt="Responsive Logo">
            </a>
          </div>
          <ul>
            <li class="menu-item-has-children">
  ...
  <footer class="footer-style-one" style="background-image: url(https://via.placeholder.com/1920x732);">
        ...
        <div class="row">
          <div class="footer-first">
            <div class="footer-logo">
              <a href="index.html">
                <img src="{{ asset('assets_private/images/log_text_mad.png') }}" alt="Footer Logo">
            ...
            <div class="contact-info d-flex-all">
              <div class="images d-flex-all justify-content-start">
                <figure>
                  <img src="https://via.placeholder.com/57x57" alt="Contact Images">
                </figure>
                <figure>
                  <img src="https://via.placeholder.com/57x57" alt="Contact Images">
                </figure>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="footer-col">
              <h3>Información</h3>
              <p>Los viajes regulares al gimnasio son geniales, pero no te preocupes si no puedes encontrar un gran bloque de tiempo para hacer ejercicio todos los días.</p>
              <ul class="social-media">
                <li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
                <li><a href="#"><i class="flaticon-twitter"></i></a></li>
                <li><a href="#"><i class="flaticon-instagram"></i></a></li>
              ...
              <ul>
                <li>
                   <i class="flaticon-maps"></i>
                    <p>901 Calle Pitt, Oficina 170, VA 22314, EE.UU.</p>
                </li>
                <li>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="footer-col">
              ...
              <p>Suscríbete a nuestro boletín semanal para recibir las últimas noticias.</p>
              <form>
    ...
    <div class="footer-p-3 rights">
      <div class="container">
        <div class="row">
          <div class="footer-col">
            <p>Centro de fitness del gimnasio <i class="fa-solid fa-heart"></i> © 2024 <a href="https://winsfolio.net/">winsfolio.net</a> Todos los derechos reservados</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="contact-form-one popup">
              <div class="c-form-2">
                ...
                <form>
                  ...
                  <div class="row g-0">
                    <textarea placeholder="Pregunta / Mensaje?"></textarea>
                  </div>
                  <button type="submit" class="theme-btn">Enviar ahora</button>
                </form>
              </div>
            </div>
          </div>
