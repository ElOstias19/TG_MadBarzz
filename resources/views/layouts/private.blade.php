...
<head>
    ...
    <meta name="keywords" content="admin, panel de administración, plantilla admin, bootstrap, bootstrap 5, plantilla admin bootstrap 5, fitness, admin fitness, moderno, panel de administración responsive, panel de ventas, sass, kit ui, aplicación web">
    <meta name="description" content="Descubre MadBarzz, la solución fitness definitiva diseñada para ayudarte a lograr un estilo de vida más saludable con sus características innovadoras y programas personalizados. MadBarzz es una plantilla de panel de administración completamente responsive que ofrece la combinación perfecta de ejercicio, nutrición y motivación. Comienza tu viaje fitness hoy con MadBarzz.">

    <meta property="og:title" content="MadBarzz - Plantilla de Panel de Administración Fitness Bootstrap">
    <meta property="og:description" content="Descubre MadBarzz, la solución fitness definitiva diseñada para ayudarte a lograr un estilo de vida más saludable con sus características innovadoras y programas personalizados. MadBarzz es una plantilla de panel de administración completamente responsive que ofrece la combinación perfecta de ejercicio, nutrición y motivación. Comienza tu viaje fitness hoy con MadBarzz.">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="user_info">
                                                ...
                                                <p>Taherah se fue hace 7 mins</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="user_info">
                                                ...
                                                <p>Nargis se fue hace 30 mins</p>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            ...
                                            <div class="user_info">
                                                ...
                                                <p>Rashid se fue hace 50 mins</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dz-chat-user">
                            ...
                            <div class="card-header chat-list-header text-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li class="dropdown-item"><i class="fa fa-users text-primary me-2"></i> Añadir a amigos cercanos</li>
                                        <li class="dropdown-item"><i class="fa fa-plus text-primary me-2"></i> Añadir a grupo</li>
                        ...
                        <div class="card mb-sm-3 mb-md-0 note_card">
                            <div class="card-header chat-list-header text-center">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Añadir Nueva Nota</p>
                                </div>
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><path d="M14.2928932,16.7071068 C13.9023689,16.3165825 13.9023689,15.6834175 14.2928932,15.2928932 C14.6834175,14.9023689 15.3165825,14.9023689 15.7071068,15.2928932 L19.7071068,19.2928932 C20.0976311,19.6834175 20.0976311,20.3165825 19.7071068,20.7071068 C19.3165825,21.0976311 18.6834175,21.0976311 18.2928932,20.7071068 L14.2928932,16.7071068 Z" fill="#000000" fill-rule="nonzero" opacity="0.3"/><path d="M11,16 C13.7614237,16 16,13.7614237 16,11 C16,8.23857625 13.7614237,6 11,6 C8.23857625,6 6,8.23857625 6,11 C6,13.7614237 8.23857625,16 11,16 Z M11,18 C7.13400675,18 4,14.8659932 4,11 C4,7.13400675 7.13400675,4 11,4 C14.8659932,4 18,7.13400675 18,11 C18,14.8659932 14.8659932,18 11,18 Z" fill="#000000" fill-rule="nonzero"/></g></svg></a>
                            </div>
           ...
           <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
  							...
  							<li><a href="{{ route(name: 'roles.index')   }}">Roles</a></li>
                            <li><a href="{{ route(name: 'users.index')   }}">Usuarios</a></li>
				...
				<div class="add-menu-sidebar">
					<img src="{{ asset('assets_private/images/calendar.png') }}" alt="" class="me-3">
					<a href="workoutplan.html" class="font-w500 mb-0">Create Workout Plan Now</a>
				</div>
				<div class="copyright">
					<p><strong>MadBarzz</strong> © 2023 All Rights Reserved</p>
